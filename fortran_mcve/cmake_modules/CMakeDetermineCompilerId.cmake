...
")
  ...
  if("${CMAKE_GENERATOR}" MATCHES "Visual Studio ([0-9]+)")
    ...
    if(command)
      message(STATUS "PATCHED: about to run compiler id command: ${command}")
      execute_process(
        COMMAND ${command}
      ...
      message(WARNING "PATCHED devenv/MSBuild execute_process returned: ${CMAKE_${lang}_COMPILER_ID_RESULT}")
    else()
